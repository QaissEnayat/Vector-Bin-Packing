...
def ffd_item_centric(bin_list, item_list):
    print_item_list(item_list)
    item_list = sorted(item_list, key=resource_sum, reverse=True)
    print_item_list(item_list)
...
def ffd_bin_centric(bin_list, item_list):
...
# ffd_bin_centric(bin_list, item_list)
ffd_item_centric(bin_list, item_list)
